...
{
    class FitnessDataBaseContext: DbContext
    {
        public readonly DateTime DateTimeMinValue = new DateTime(1753, 01, 01, 0, 00, 00);
        protected internal static readonly String DBConnection = $"Data Source = {Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)}\\Fitness.sdf";
